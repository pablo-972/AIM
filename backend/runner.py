...
def run_full_local_pipeline(
    ...
    orchestrator.run_full_static_phase(orchestrator.context, event_sink=event_sink)
    orchestrator.run_full_dynamic_phase(orchestrator.context, event_sink=event_sink)
    orchestrator.run_full_enrichment_phase(orchestrator.context, event_sink=event_sink)
    orchestrator.run_full_reverse_info_phase(orchestrator.context, event_sink=event_sink)
    orchestrator.run_full_reverse_agent_phase(orchestrator.context, event_sink=event_sink)
    orchestrator.run_full_report_phase(orchestrator.context, event_sink=event_sink)
