...
class AgentMemory:
    def __init__(self, output_dir: str, filename: str, flush_interval: int | None = None) -> None:
    ...
    def record(self, decision: dict[str, Any], tool_name: str | None = None, tool_output: dict[str, Any] | None = None) -> None:
